...
MINT runs [Prince XML](https://www.princexml.com/) as a Lambda function to
convert HTML to PDF.

See the
[mint-infra-modules](https://github.com/CMSgov/mint-infra-modules/blob/master/lambda/prince/README.md)
