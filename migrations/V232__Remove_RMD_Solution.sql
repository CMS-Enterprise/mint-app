...
WITH poc_table AS (
    ...
    WHERE solution.mto_common_solution_key::TEXT = 'RMD' 
)

-- Replace existing RMD from common solution to custom solution
UPDATE mto_solution AS solution
SET 
    mto_common_solution_key = NULL,
    name = 'Rapid Measure Development (RMD)',
    type = 'IT_SYSTEM',
...
-- Delete RMD contacts, contractors, and system owners
DELETE FROM mto_common_solution_contact 
WHERE mto_common_solution_key::TEXT = 'RMD';
...
-- Delete RMD row from common solutions
