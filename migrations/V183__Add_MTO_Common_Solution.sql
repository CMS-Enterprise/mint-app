CREATE TYPE MTO_COMMON_SOLUTION_KEY AS ENUM (
    'INNOVATION', 'ACO_OS', 'APPS', 'CDX', 'CCW', 'CMS_BOX', 'CMS_QUALTRICS', 'CBOSC', 'CPI_VETTING', 'EFT', 'EXISTING_CMS_DATA_AND_PROCESS', 'EDFR', 'GOVDELIVERY', 'GS', 'HDR', 'HPMS', 'HIGLAS', 'IPC', 'IDR', 'LDG', 'LV', 'MDM_POR', 'MARX', 'OUTLOOK_MAILBOX', 'QV', 'RMADA', 'ARS', 'CONNECT', 'LOI', 'POST_PORTAL', 'RFA', 'SHARED_SYSTEMS', 'BCDA', 'ISP', 'MIDS', 'MDM_NCBP', 'MODEL_SPACE'
);
