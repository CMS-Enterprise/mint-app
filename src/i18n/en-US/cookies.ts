const cookies = {
  ...
  cookieUsage: {
    ...
    generationOfCookies:
      'When you visit any website, its server may generate a piece of text known as a "cookie to place on your computer. The cookie allows the server to "remember" specific information about your visit while you are connected. The cookie makes it minter for you to use the dynamic features of Web pages. Cookies from CMS websites collect only information about your browser\'s visit to the site. They do not collect personal information about you.',
    typesOfCookies:
