const getAccess = {
  ...
  jobcodes: {
    ...
    table: {
      ...
      rowFour: {
        role: 'Any other CMS contractors with an approved need for access to MINT',
  ...
  stepsEUA: {
    ...
    second: {
      ...
      description: {
        one: 'Click <0>Modify My Job Codes</0> in the Tasks menu on the left side of the screen.',
        two: 'Read and confirm the process of modifying job codes. Then, click the <0>Next</0> button.',
        three:
          'You’ll see a screen with all of your active job codes. Below the list, click the <0>Add a Job Code</0> button.',
        four: 'Type the name of the job code into the search box (either <0>MINT_USER</0>, <0>MINT_CONTRACTOR_FFS</0> or <0>MINT_NON_CMS</0> determined using the chart above) and click the <0>Search</0> button.',
        five: 'Check the box next to the job code, then click the <0>Select</0> button.',
        six: 'Enter a justification reason, then click the <0>Finish</0> button.'
      }
    },
    third: {
  ...
  stepsIDM: {
    first: {
      ...
      description: {
        one: 'If you have access to EUA and are currently signed in, we recommend completing these steps in an incognito browser.',
        two: 'Visit <0>home.idm.cms.gov</0> and sign in with your credentials. Do not use your PIV card.'
      }
    },
    second: {
      ...
      description: {
        ...
        two: 'The Role Request window will appear with a dropdown to select an application. Select <0>Model Innovation Tool (MINT)</0>.',
    ...
    third: {
      ...
      description: {
        one: 'If you have previously requested a role for another application through your IDM account, you may not need to complete this step.',
        two: 'Review the RIDP terms and conditions, check the “I agree to the terms and conditions” selection box, then click the <0>Next</0> button. The Identity Verification form appears.',
        three:
          'Complete the Identity Verification form and click the <0>Next</0> button. The RIDP proofing questions appear. ',
        four: 'Answer the proofing questions and click the <0>Verify</0> button. ',
        five: 'You will see an RIDP success message. Then, click the <0>Continue</0> button. '
      }
    },
    fourth: {
      heading: 'Review request',
      description: {
        one: 'Review the role request information and enter the reason you need to access MINT.',
        two: 'Then, click the <0>Submit Role Request</0> button. The Role Request window displays a Request ID and a message which states that the request was successfully submitted to an approver for action.',
        three:
    ...
    fifth: {
      ...
      description: {
        one: 'After you submit your role request, the approver is notified. Follow-up emails may send upon approval, rejection, or expiration if no action is taken by an approver.',
        two: 'If you wish to check the status of your role request, click <0>My Requests</0> on the Self Service Dashboard. All of your open requests will be listed there. You can also see all of your approved roles by clicking on <0>Manage My Roles</0>.'
      }
    },
    sixth: {
      heading: 'Sign in to MINT',
