const auth = {
  modal: {
    title_minute: 'Your access to CMMI will expire in {{count}} minute',
    title_minute_plural: 'Your access to CMMI will expire in {{count}} minutes',
    title_second: 'Your access to CMMI will expire in {{count}} second',
    title_second_plural: 'Your access to CMMI will expire in {{count}} seconds',
