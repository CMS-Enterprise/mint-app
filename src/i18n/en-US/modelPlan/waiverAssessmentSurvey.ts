...
const waiverAssessmentSurvey: TranslationWaiverAssessmentSurvey = {
  ...
  isEmptyWaiversConfirmed: {
    gqlField: 'isEmptyWaiversConfirmed',
    goField: 'IsEmptyWaiversConfirmed',
    dbField: 'is_empty_waivers_confirmed',
    label: 'Check this box to confirm your model does not require any waivers',
    dataType: TranslationDataType.BOOLEAN,
    formType: TranslationFormType.CHECKBOX,
    order: 4.1,
    options: {
      true: 'Check this box to confirm your model does not require any waivers',
      false: 'No'
    },
