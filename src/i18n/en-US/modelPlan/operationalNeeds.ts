...
const operationalNeeds: TranslationOperationalNeeds = {
  ...
  key: {
    ...
    options: {
      ...
      ACQUIRE_AN_IMP_CONT: 'Acquire an implementation contractor',
      ACQUIRE_A_PRE_IMP_CONT:
        'Acquire support from a pre-implementation contractor',
      ACQUIRE_A_DATA_AGG_CONT:
        'Acquire support from a data aggregation contractor',
      SEND_DASHBOARDS_REPORTS_TO_PART:
        'Send dashboards and/or reports to participants',
      SEND_DATA_VIA_API_TO_PART: 'Send data via API to participants',
      SEND_RAW_FILES_TO_PART: 'Send raw files to participants',
      SIGN_COOPERATIVE_AGREEMENTS: 'Sign Cooperative Agreements'
    }
  },
  needed: {
    gqlField: 'needed',
