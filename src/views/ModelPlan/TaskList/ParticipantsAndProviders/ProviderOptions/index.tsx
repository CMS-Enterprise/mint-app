            ...
            <>
              ...
              >
                      ...
                      key => (
                        <Fragment key={key}>
                          <Field
                            ...
                            label={providerAdditionFrequencyConfig.options[key]}
                            value={key}
                ...
                <FieldArray
                  ...
                  render={arrayHelpers => (
                    <>
                      ...
                      <p className="text-base margin-0 line-height-body-3">
                        {participantsAndProvidersT('providerLeaveMethod.hint')}
                      </p>
                ...
                >
                  ...
                  {(values.providerOverlap === OverlapType.YES_NEED_POLICIES ||
