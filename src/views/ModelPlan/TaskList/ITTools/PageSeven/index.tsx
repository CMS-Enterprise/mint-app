...
import {
  ...
  GetITToolPageSeven_modelPlan_opsEvalAndLearning as OpsEvalAndLearnignFormType,
...
const ITToolsPageSeven = () => {
  ...
  } = data?.modelPlan?.itTools || ({} as ITToolsPageSevenFormType);
  ...
  const initialValues: ITToolsPageSevenFormType = {
