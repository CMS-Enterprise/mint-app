        ...
        {isCR ? (
          <>
            ...
            <div>
              ...
              <p>
                {emergencyCrFlag ? i18n.t('general:yes') : i18n.t('general:no')}
              </p>
            </div>
            <div>
              <p className="text-bold">
              ...
              <p>
                {sensitiveFlag ? i18n.t('general:yes') : i18n.t('general:no')}
              </p>
            </div>
            <div>
              <p className="text-bold">{crtdlsT('echimpCard.relatedCrTdl')}</p>
