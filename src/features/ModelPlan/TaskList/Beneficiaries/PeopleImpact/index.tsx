...
const PeopleImpact = () => {
  ...
  return (
    <MainContent data-testid="beneficiary-people-impact">
      <GridContainer>
        <MutationErrorModal
                      ...
                      >
                        <Fieldset disabled={!!error || loading}>
                              ...
                              {getKeys(estimateConfidenceConfig.options).map(
                                key => (
                                  <Field
                                    ...
                                    label={
                                      estimateConfidenceConfig.options[key]
                                    }
                                    value={key}
                          ...
                          <FieldGroup className="margin-top-4">
                            ...
                            >
                              {beneficiariesT(
                                'beneficiarySelectionMethod.label'
                              )}
                            </Label>
                            ...
                            {(
                              values?.beneficiarySelectionMethod || []
                            ).includes(SelectionMethodType.OTHER) && (
                              <FieldGroup>
                                <Label
