...
const FilterForm = ({
  ...
  return (
    ...
    >
      <div data-testid="filter-form-content">
                  ...
                  {collaborators.map((collaborator, index) => (
                    <Grid key={collaborator} col={6}>
                      <Checkbox
                        ...
                        data-testid={`collaborators-${collaborator}`}
                        name={collaborator}
                        value={collaborator}
                        label={collaborator}
            ...
            <div className="padding-y-4 border-bottom-1px border-base-lighter">
              ...
              <div className="margin-bottom-4 margin-top-05">
                ...
                <Checkbox
                  ...
                  data-testid={`typeOfChange-${TypeOfChange.ALL_MODEL_PLAN_SECTIONS}`}
