      ...
      <GridContainer>
        <Grid tablet={{ col: 12 }}>
          ...
          <div className="mint-body-medium">
            ...
            <h2 className="margin-top-4 margin-bottom-1">{t('partsOfMTO')}</h2>

            <p className="margin-bottom-3 margin-top-1">
              {t('partsOfMTODescription')}
            </p>

            <h3 className="margin-top-3 margin-bottom-1">{t('milestones')}</h3>

            <p className="margin-bottom-2 margin-top-1">
              {t('milestonesDescription')}
            </p>

            <h3 className="margin-top-3 margin-bottom-1">{t('categories')}</h3>
