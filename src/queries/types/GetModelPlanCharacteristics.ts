...
// ====================================================
// GraphQL query operation: GetModelPlanCharacteristics
// ====================================================

export interface GetModelPlanCharacteristics_modelPlan_generalCharacteristics {
...
export interface GetModelPlanCharacteristics {
  modelPlan: GetModelPlanCharacteristics_modelPlan;
}

export interface GetModelPlanCharacteristicsVariables {
  id: UUID;
}
