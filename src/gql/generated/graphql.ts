...
export type GetEchimpCrandTdlQuery = { __typename: 'Query', modelPlan: { __typename: 'ModelPlan', id: UUID, echimpCRsAndTDLs: Array<{ __typename: 'EChimpCR', id: string, title?: string | null, emergencyCrFlag?: boolean | null, sensitiveFlag?: boolean | null, crStatus?: string | null, implementationDate?: string | null, initiator?: string | null, relatedCrTdlNumbers?: string | null, crSummary?: { __typename: 'TaggedContent', rawContent: string } | null } | { __typename: 'EChimpTDL', id: string, title?: string | null, issuedDate?: string | null, status?: string | null }> } };
...
export type GetFavoritesQuery = { __typename: 'Query', modelPlanCollection: Array<{ __typename: 'ModelPlan', id: UUID, modelName: string, isFavorite: boolean, nameHistory: Array<string>, isCollaborator: boolean, status: ModelStatus, basics: { __typename: 'PlanBasics', id: UUID, goal?: string | null, performancePeriodStarts?: Time | null }, collaborators: Array<{ __typename: 'PlanCollaborator', id: UUID, teamRoles: Array<TeamRole>, userAccount: { __typename: 'UserAccount', id: UUID, commonName: string } }>, echimpCRsAndTDLs: Array<{ __typename: 'EChimpCR', id: string } | { __typename: 'EChimpTDL', id: string }> }> };
...
export type GetModelSummaryQuery = { __typename: 'Query', modelPlan: { __typename: 'ModelPlan', id: UUID, modelName: string, abbreviation?: string | null, createdDts: Time, modifiedDts?: Time | null, status: ModelStatus, isFavorite: boolean, isCollaborator: boolean, echimpCRsAndTDLs: Array<{ __typename: 'EChimpCR', id: string } | { __typename: 'EChimpTDL', id: string }>, basics: { __typename: 'PlanBasics', goal?: string | null, performancePeriodStarts?: Time | null }, generalCharacteristics: { __typename: 'PlanGeneralCharacteristics', keyCharacteristics: Array<KeyCharacteristic> }, collaborators: Array<{ __typename: 'PlanCollaborator', teamRoles: Array<TeamRole>, userAccount: { __typename: 'UserAccount', id: UUID, commonName: string, email: string, username: string } }> } };
