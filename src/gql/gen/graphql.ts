...
export type GetModelsBySolutionQuery = { __typename: 'Query', modelPlansByOperationalSolutionKey: Array<{ __typename: 'ModelPlanAndOperationalSolution', modelPlan: { __typename: 'ModelPlan', id: UUID, modelName: string, status: ModelStatus, statusPlannedActiveOrEnded: ModelBySolutionStatus, basics: { __typename: 'PlanBasics', id: UUID, modelCategory?: ModelCategory | null, performancePeriodStarts?: Time | null, performancePeriodEnds?: Time | null } } }> };
 ...
 * });
 */
export function useGetModelsBySolutionQuery(baseOptions: Apollo.QueryHookOptions<GetModelsBySolutionQuery, GetModelsBySolutionQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
...
export function useGetModelsBySolutionSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetModelsBySolutionQuery, GetModelsBySolutionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
