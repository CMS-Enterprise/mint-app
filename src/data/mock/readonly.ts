...
const participantsAndProvidersData: GetAllParticipantsTypes = {
  ...
  providerAdditionFrequency: [FrequencyTypeNew.OTHER],
...
const beneficiaryData: AllBeneficiariesTypes = {
  ...
  beneficiarySelectionFrequency: [FrequencyTypeNew.ANNUALLY],
  beneficiarySelectionFrequencyContinually: 'Frequency continually',
...
const opsEvalAndLearningData: AllOpsEvalAndLearningTypes = {
  ...
  dataSharingFrequency: [FrequencyTypeNew.MONTHLY],
  ...
  dataCollectionFrequency: [FrequencyTypeNew.ANNUALLY],
...
const paymentsData: PaymentTypes = {
  ...
  anticipatedPaymentFrequency: [FrequencyTypeNew.SEMIANNUALLY],
