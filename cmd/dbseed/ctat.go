...
func (s *Seeder) seedCTATRequests(
	...
	s.createCTATRequest(requesterBTAL, &model.CTATRequestInput{
		...
		ContractType:           &costReimbursement,
		TypeOfHelpNeeded:       []models.CTATHelpNeededType{models.CTATHelpNeededTypeCalmSystemRequisitionSupport, models.CTATHelpNeededTypeDocumentingAndSubmittingCPARS},
	...
	s.createCTATRequest(requesterBTMN, &model.CTATRequestInput{
		...
		ContractActivityType:   &learningActivity,
		ContractType:           &costPlusFixedFee,
		TypeOfHelpNeeded:       []models.CTATHelpNeededType{models.CTATHelpNeededTypeGuidanceOnMarketResearch, models.CTATHelpNeededTypeDocumentingAndSubmittingCPARS},
