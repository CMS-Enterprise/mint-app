...
func (o *UserFindListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.UserFindResponse)
...
func (o *UserFindListBadRequest) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *UserFindListUnauthorized) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *UserFindListInternalServerError) GetPayload() *models2.Response {
	return o.Payload
}
