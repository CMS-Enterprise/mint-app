...
func (o *StakeholderFindListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.StakeholderFindResponse)
...
func (o *StakeholderFindListBadRequest) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *StakeholderFindListUnauthorized) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *StakeholderFindListNotFound) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *StakeholderFindListInternalServerError) GetPayload() *models2.Response {
	return o.Payload
}
