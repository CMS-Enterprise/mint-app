...
func (o *ExchangeFindByIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.Exchange)
...
func (o *ExchangeFindByIDBadRequest) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *ExchangeFindByIDUnauthorized) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *ExchangeFindByIDInternalServerError) GetPayload() *models2.Response {
	return o.Payload
}
