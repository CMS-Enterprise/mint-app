...
func (o *ExchangeFindListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.ExchangeFindResponse)
...
func (o *ExchangeFindListBadRequest) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *ExchangeFindListUnauthorized) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *ExchangeFindListInternalServerError) GetPayload() *models2.Response {
	return o.Payload
}
