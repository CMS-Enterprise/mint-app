...
func (o *DeploymentFindListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.DeploymentFindResponse)
...
func (o *DeploymentFindListBadRequest) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *DeploymentFindListUnauthorized) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *DeploymentFindListInternalServerError) GetPayload() *models2.Response {
	return o.Payload
}
