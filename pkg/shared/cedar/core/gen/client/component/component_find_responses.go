...
func (o *ComponentFindOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.ComponentFindResponse)
...
func (o *ComponentFindBadRequest) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *ComponentFindUnauthorized) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *ComponentFindInternalServerError) GetPayload() *models2.Response {
	return o.Payload
}
