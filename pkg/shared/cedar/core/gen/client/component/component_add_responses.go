...
func (o *ComponentAddOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.ComponentAddResponse)
...
func (o *ComponentAddBadRequest) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *ComponentAddUnauthorized) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *ComponentAddInternalServerError) GetPayload() *models2.Response {
	return o.Payload
}
