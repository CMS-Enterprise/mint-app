...
func (o *RoleTypeFindOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.RoleTypeFindResponse)
...
func (o *RoleTypeFindBadRequest) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *RoleTypeFindUnauthorized) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *RoleTypeFindNotFound) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *RoleTypeFindInternalServerError) GetPayload() *models2.Response {
	return o.Payload
}
