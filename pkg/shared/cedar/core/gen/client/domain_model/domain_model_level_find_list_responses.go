...
type DomainModelLevelFindListOK struct {
	Payload *models2.DomainModelLevelFindResponse
}
...
func (o *DomainModelLevelFindListOK) GetPayload() *models2.DomainModelLevelFindResponse {
	return o.Payload
}
...
func (o *DomainModelLevelFindListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.DomainModelLevelFindResponse)
...
func (o *DomainModelLevelFindListBadRequest) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *DomainModelLevelFindListUnauthorized) GetPayload() *models2.Response {
	return o.Payload
}
...
func (o *DomainModelLevelFindListInternalServerError) GetPayload() *models2.Response {
	return o.Payload
}
