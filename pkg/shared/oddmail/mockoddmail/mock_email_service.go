...
// Source: pkg/shared/oddmail/email_service.go
...
func (m *MockEmailService) GetConfig() oddmail.EmailServiceConfig {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetConfig")
	ret0, _ := ret[0].(oddmail.EmailServiceConfig)
	return ret0
}
...
func (m *MockEmailService) Send(from string, toAddresses, ccAddresses []string, subject, contentType, body string, opts ...oddmail.EmailOption) error {
	m.ctrl.T.Helper()
