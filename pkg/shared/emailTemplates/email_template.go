...
func NewEmailTemplate(templateCache *TemplateCache, subjectTemplateName string, bodyTemplateName string) *EmailTemplate {
	return &EmailTemplate{subjectTemplateName: subjectTemplateName, bodyTemplateName: bodyTemplateName}
}
