...
func ActivityDatesChangedCreate(ctx context.Context, np sqlutils.NamedPreparer, actorID uuid.UUID, modelPlanID uuid.UUID, datesChanged []models.DateChange, recipients []*models.UserAccountAndNotifPreferences, getPreferencesFunc GetUserNotificationPreferencesFunc) (*models.Activity, error) {
