...
func ActivityDailyDigestComplete(ctx context.Context, np sqlutils.NamedPreparer, actorID uuid.UUID, userID uuid.UUID, date time.Time, modelPlanIDs []uuid.UUID, pref *models.UserNotificationPreferences) (*models.Activity, error) {
