...
func (suite *NotificationsSuite) TestActivityTaggedInDiscussionReplyCreate() {
	tag1EUA := "SKZO"
	...
	suite.EqualValues(models.ActivityTaggedInDiscussionReply, testActivity.ActivityType)
