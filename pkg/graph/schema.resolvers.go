...
func (r *planBasicsResolver) ModelType(ctx context.Context, obj *models.PlanBasics) ([]model.ModelType, error) {
	modelTypes := models.ConvertEnums[model.ModelType](obj.ModelType)
