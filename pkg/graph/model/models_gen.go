...
type ModelPlanTranslation struct {
	...
	MtoReadyForReviewBy  models.TranslationField            `json:"mtoReadyForReviewBy" db:"mto_ready_for_review_by"`
	MtoReadyForReviewDts models.TranslationField            `json:"mtoReadyForReviewDts" db:"mto_ready_for_review_dts"`
}
