...
var AllYesNoFilter = []YesNoFilter{
	YesNoFilterYes,
	YesNoFilterNo,
}

func (e YesNoFilter) IsValid() bool {
	switch e {
	case YesNoFilterYes, YesNoFilterNo:
		return true
	}
	return false
}

func (e YesNoFilter) String() string {
	return string(e)
}

func (e *YesNoFilter) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}
	...
	*e = YesNoFilter(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid YesNoFilter", str)
	}
	return nil
}

func (e YesNoFilter) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}
