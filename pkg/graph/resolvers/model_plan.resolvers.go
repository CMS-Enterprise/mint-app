...
func (r *modelPlanResolver) DataExchangeApproach(ctx context.Context, obj *models.ModelPlan) (*models.DataExchangeApproach, error) {
	return DataExchangeApproachGetByModelPlanIDLOADER(ctx, obj.ID)
}
