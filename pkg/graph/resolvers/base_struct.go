...
func BaseStructPreUpdate(logger *zap.Logger, bs models.IBaseStruct, changes map[string]any, principal authentication.Principal, store *storage.Store, applyChanges bool, checkAccess bool) error {
