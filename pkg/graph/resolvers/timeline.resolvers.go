...
// UpdateTimeline implements resolver logic to update a timeline object
func UpdateTimeline(
	ctx context.Context,
	logger *zap.Logger,
	id uuid.UUID,
...
// TimelineGetByModelPlanIDLOADER implements resolver logic to get timeline by a model plan ID using a data loader
