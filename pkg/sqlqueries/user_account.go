...
//go:embed SQL/user_account/get_lead_model_plans.sql
var userAccountGetLeadModelPlans string
...
var UserAccount = userAccountScripts{
	...
	GetLeadModelPlans:     userAccountGetLeadModelPlans,
