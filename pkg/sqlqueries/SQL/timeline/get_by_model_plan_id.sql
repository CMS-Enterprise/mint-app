SELECT
    ...
    timeline.demo_code,
    timeline.ams_model_id,
    timeline.model_category,
    timeline.additional_model_categories,
    timeline.cms_centers,
    timeline.cmmi_groups,
    timeline.model_type,
    timeline.model_type_other,
    timeline.problem,
    timeline.goal,
    timeline.test_interventions,
    timeline.note,
