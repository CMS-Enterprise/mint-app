-- TODO: UNTESTED AND UNFINISHED, TO BE COMPLETED AS PART OF MILESTONE-SOLUTION LINKING
...
INNER JOIN mto_milestone_solution_link
    ON mto_solution.id = mto_milestone_solution_link.solution_id
INNER JOIN QUERIED_IDS AS qIDs
    ON mto_solution.id = qIDs.id
WHERE mto_milestone_solution_link.milestone_id = qIDs.id;
