...
all_models AS (
    ...
    WHERE
        iddoc_questionnaire_completed_notification_type = 'ALL_MODELS'
),
...
collaborators AS (
    ...
    WHERE
        ...
        AND unp.iddoc_questionnaire_completed_notification_type = 'MY_MODELS'
),
...
followers AS (
    ...
    WHERE
        ...
        AND unp.iddoc_questionnaire_completed_notification_type = 'FOLLOWED_MODELS'
),
...
SELECT
    ...
    ua.zone_info,
    ua.has_logged_in,
    unp.iddoc_questionnaire_complete AS preference_flags
FROM combined_users
