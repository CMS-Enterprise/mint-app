...
all_models AS (
    ...
    WHERE
        mto_ready_for_review_notification_type = 'ALL_MODELS'
),
...
collaborators AS (
    ...
    WHERE
        ...
        AND unp.mto_ready_for_review_notification_type = 'MY_MODELS'
),
...
followers AS (
    ...
    WHERE
        ...
        AND unp.mto_ready_for_review_notification_type = 'FOLLOWED_MODELS'
),
...
SELECT
    ...
    ua.zone_info,
    ua.has_logged_in,
    unp.mto_ready_for_review AS preference_flags
FROM combined_users
