...
all_models AS (
    ...
    WHERE
        new_discussion_added_notification_type = 'ALL_MODELS'
),
...
collaborators AS (
    ...
    WHERE
        ...
        AND unp.new_discussion_added_notification_type = 'MY_MODELS'
),
...
followers AS (
    ...
    WHERE
        ...
        AND unp.new_discussion_added_notification_type = 'FOLLOWED_MODELS'
),
...
SELECT
    ...
    ua.zone_info,
    ua.has_logged_in,
    unp.new_discussion_added AS preference_flags
FROM combined_users
