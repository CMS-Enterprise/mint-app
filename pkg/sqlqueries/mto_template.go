...
//go:embed SQL/mto/template/get_by_id_LOADER.sql
var mtoTemplateGetByIDLoaderSQL string

//go:embed SQL/mto/template/get_by_model_plan_id_LOADER.sql
var mtoTemplateGetByModelPlanIDLoaderSQL string

//go:embed SQL/mto/template/get_by_key_LOADER.sql
var mtoTemplateGetByKeyLoaderSQL string

//go:embed SQL/mto/template/get_all.sql
