...
type PlanOpsEvalAndLearning struct {
	...
	QualityPerformanceImpactsPayment             *QualityPerformanceImpactType `json:"qualityPerformanceImpactsPayment" db:"quality_performance_impacts_payment" statusWeight:"1"`
...
const (
	QualityPerformanceImpactTypeYes   QualityPerformanceImpactType = "YES"
	QualityPerformanceImpactTypeNo    QualityPerformanceImpactType = "NO"
	QualityPerformanceImpactTypeOther QualityPerformanceImpactType = "OTHER"
)
