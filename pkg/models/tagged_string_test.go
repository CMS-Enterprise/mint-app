...
func TestNewTagFromString(t *testing.T) {
	...
	tagString := `<tag type="USER_ACCOUNT" entityID="34508e34-e3a8-4c1c-8d08-820d71995300"/>`
	...
	assert.EqualValues(t, TagTypeUserAccount, tag.Type)

	solutionID := 4
	tagType := TagTypePossibleSolution
