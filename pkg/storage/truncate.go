...
func (s *Store) TruncateAllTablesDANGEROUS(logger *zap.Logger) error {
	...
	tables := []string{
		...
		string(models.TNMTOTemplateMilestoneSolutionLink),
		string(models.TNMTOTemplateMilestone),
		string(models.TNMTOTemplateSolution),
		string(models.TNMTOTemplateCategory),
		string(models.TNMTOTemplate),
