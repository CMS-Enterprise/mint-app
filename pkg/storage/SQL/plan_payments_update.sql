...
SET
    ...
    funding_source_trust_fund_description = :funding_source_trust_fund_description,
    funding_source_other_description = :funding_source_other_description,
    funding_source_note = :funding_source_note,
    funding_source_r = :funding_source_r,
    funding_source_r_trust_fund_description = :funding_source_r_trust_fund_description,
    funding_source_r_other_description = :funding_source_r_other_description,
    ...
    pay_claims_other_description = :pay_claims_other_description,
    ...
    affects_medicare_secondary_payer_claims_explanation = :affects_medicare_secondary_payer_claims_explanation,
    ...
    non_claims_payments_other_description = :non_claims_payments_other_description,
    payment_calculation_owner = :payment_calculation_owner,
    number_payments_per_pay_cycle = :number_payments_per_pay_cycle,
    number_payments_per_pay_cycle_notes = :number_payments_per_pay_cycle_notes,
    ...
    funding_center_description = :funding_center_description,
    ...
    can_participants_select_between_payment_mechanisms_description = :can_participants_select_between_payment_mechanisms_description,
    ...
    anticipated_payment_frequency_other_description = :anticipated_payment_frequency_other_description,
    anticipated_payment_frequency_notes = :anticipated_payment_frequency_notes,
    will_recover_payments = :will_recover_payments,
    will_recover_payments_notes = :will_recover_payments_notes,
    anticipate_reconciling_payments_retrospectively = :anticipate_reconciling_payments_retrospectively,
    anticipate_reconciling_payments_retrospectively_notes = :anticipate_reconciling_payments_retrospectively_notes,
    payment_start_date = :payment_start_date,
    payment_start_date_notes = :payment_start_date_notes,
...
model_plan_id,
funding_source,
funding_source_trust_fund_description,
funding_source_other_description,
funding_source_note,
funding_source_r,
funding_source_r_trust_fund_description,
funding_source_r_other_description,
...
affects_medicare_secondary_payer_claims_explanation,
...
non_claims_payments,
non_claims_payments_other_description,
payment_calculation_owner,
number_payments_per_pay_cycle,
number_payments_per_pay_cycle_notes,
...
can_participants_select_between_payment_mechanisms_description,
can_participants_select_between_payment_mechanisms_note,
anticipated_payment_frequency,
anticipated_payment_frequency_other_description,
