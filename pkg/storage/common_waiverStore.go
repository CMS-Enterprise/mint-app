...
// If model plan id is provided, it will provide contextual information such as will_use_waiver,
// using_reason, not_using_reason, and suggested_waiver_id. If not, those fields will be null/zero value.
